...
urlpatterns = [
    ...
    path(
        'disbursement/e-wallets/',
        views.DisbursementHomeView.as_view(),
        name='e_wallets_home',
    ),
    path(
        'disbursement/bank-wallets/',
        views.BanksHomeView.as_view(),
        name='bank_wallets_home',
    ),
    path(
        'disbursement/bank-cards/',
        views.BanksHomeView.as_view(),
        name='bank_cards_home',
    ),
    ...
    path(
        ...
        views.RetrieveCollectionData.as_view(),
