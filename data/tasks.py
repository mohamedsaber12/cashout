        ...
        # 2 For bank cards: Save the refined data as bank transactions records
            ...
            for record in processed_data:
                ...
                BankTransaction.objects.create(
                    ...
                    corporate_code=get_from_env("ACH_CORPORATE_CODE") if not doc_obj.owner.root.username in get_from_env("USERNAMRS_FOR_BM_ACH").split(",") else get_from_env("BM_ACH_CORPORATE_CODE"),
                    debtor_account=get_from_env("ACH_DEBTOR_ACCOUNT") if not doc_obj.owner.root.username in get_from_env("USERNAMRS_FOR_BM_ACH").split(",") else get_from_env("BM_ACH_DEBTOR_ACCOUNT"),
                    document=doc_obj,
