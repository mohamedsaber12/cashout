...
urlpatterns = [
    ...
    path('setting-up/dibursement-makers', views.PinFormView.as_view(),
         name='setting-dibursement-makers'),
    path('setting-up/dibursement-levels', views.PinFormView.as_view(),
         name='setting-dibursement-levels'),
    path('setting-up/dibursement-checkers', views.PinFormView.as_view(),
         name='setting-dibursement-checkers'),
    path('setting-up/dibursement-formats', views.PinFormView.as_view(),
