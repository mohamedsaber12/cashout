...
VALID_BANK_TRANSACTION_TYPES_LIST_temp = [
...
BANK_TRANSACTION_TYPES_DESCRIPTION_LIST = [
    ...
    {
        'type': _('prepaid_card'),
        'description': _('For prepaid cards and Meeza cards payments'),
    },
    {
        'type': _('cash_transfer'),
        'description': _('For bank accounts, debit cards etc..'),
    },
]
...
DEFAULT_LIST_PER_ADMIN_FOR_TRANSACTIONS_REPORT = [
    {'issuer': 'total', 'total': 0, 'count': 0, 'fees': 0, 'vat': 0},
    {'issuer': 'vodafone', 'total': 0, 'count': 0, 'fees': 0, 'vat': 0},
    {'issuer': 'etisalat', 'total': 0, 'count': 0, 'fees': 0, 'vat': 0},
    {'issuer': 'aman', 'total': 0, 'count': 0, 'fees': 0, 'vat': 0},
    {'issuer': 'orange', 'total': 0, 'count': 0, 'fees': 0, 'vat': 0},
    {'issuer': 'B', 'total': 0, 'count': 0, 'fees': 0, 'vat': 0},
    {'issuer': 'C', 'total': 0, 'count': 0, 'fees': 0, 'vat': 0},
]

DEFAULT_LIST_PER_ADMIN_FOR_TRANSACTIONS_REPORT_raseedy_vf = [
    {'issuer': 'total', 'total': 0, 'count': 0},
    {'issuer': 'vodafone', 'total': 0, 'count': 0},
    {'issuer': 'etisalat', 'total': 0, 'count': 0},
    {'issuer': 'aman', 'total': 0, 'count': 0},
    {'issuer': 'orange', 'total': 0, 'count': 0},
    {'issuer': 'B', 'total': 0, 'count': 0},
    {'issuer': 'C', 'total': 0, 'count': 0},
    {'issuer': 'default', 'total': 0, 'count': 0},
]
