...
def send_transfer_request_email(
    admin_username, message, attachment_file_name=None, **kwargs
):
    """"""
    ...
    if attachment_file_name:
        ...
        deliver_mail_to_multiple_recipients_with_attachment(
            admin_user,
            _(f" Transfer Request By User {admin_username}"),
            message,
            business_team,
            file,
        )
    elif admin_user.is_system_admin:
        deliver_mail_to_multiple_recipients_with_attachment(
            admin_user,
            _(f" Creation Request By User {admin_username}"),
            message,
            business_team,
        )
    else:
