...
MEDIA_URL = "/media/"
STATICFILES_DIRS = [os.path.join(BASE_DIR, "static"), env.str("DOCS_STATIC_ROOT")]
...
OAUTH2_PROVIDER = {
    ...
    "SCOPES": {"read": "Read scope", "write": "Write scope", "groups": "Group scope"},
...
# Timeout dictionary
TIMEOUT_CONSTANTS = {"CENTRAL_UIG": 33}
...
VODAFONE_BALANCE_SUPER_AGENT_NUMBER_PIN = env.str(
    "VODAFONE_BALANCE_SUPER_AGENT_NUMBER_PIN", ""
)
